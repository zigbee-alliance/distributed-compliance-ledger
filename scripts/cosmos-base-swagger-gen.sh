...
# generate for cosmos-sdk base proto only
...
proto_dirs=$(find proto/cosmos/base -path -prune -o -name '*.proto' -print0 | xargs -0 -n1 dirname | sort | uniq)
...
DEST_FILE="cosmos-base-openapi.json"
DESC="A REST interface for service queries"
