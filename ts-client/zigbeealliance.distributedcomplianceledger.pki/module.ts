...
export { MsgProposeAddX509RootCert, MsgApproveAddX509RootCert, MsgRemoveX509Cert, MsgRevokeX509Cert, MsgAddPkiRevocationDistributionPoint, MsgAssignVid, MsgRevokeNocRootX509Cert, MsgRejectAddX509RootCert, MsgRevokeNocX509Cert, MsgAddNocX509RootCert, MsgAddNocX509Cert, MsgUpdatePkiRevocationDistributionPoint, MsgDeletePkiRevocationDistributionPoint, MsgApproveRevokeX509RootCert, MsgAddX509Cert, MsgProposeRevokeX509RootCert };
...
type sendMsgRevokeNocRootX509CertParams = {
  value: MsgRevokeNocRootX509Cert,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgRevokeNocX509CertParams = {
  value: MsgRevokeNocX509Cert,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgAddNocX509CertParams = {
  value: MsgAddNocX509Cert,
  fee?: StdFee,
  memo?: string
};
...
type msgRevokeNocRootX509CertParams = {
  value: MsgRevokeNocRootX509Cert,
};
...
type msgRevokeNocX509CertParams = {
  value: MsgRevokeNocX509Cert,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendMsgRevokeNocRootX509Cert({ value, fee, memo }: sendMsgRevokeNocRootX509CertParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgRevokeNocRootX509Cert: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgRevokeNocRootX509Cert({ value: MsgRevokeNocRootX509Cert.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgRevokeNocRootX509Cert: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgRevokeNocX509Cert({ value, fee, memo }: sendMsgRevokeNocX509CertParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgRevokeNocX509Cert: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgRevokeNocX509Cert({ value: MsgRevokeNocX509Cert.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgRevokeNocX509Cert: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgAddNocX509Cert({ value, fee, memo }: sendMsgAddNocX509CertParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgAddNocX509Cert: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgAddNocX509Cert({ value: MsgAddNocX509Cert.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgAddNocX509Cert: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		msgRevokeNocRootX509Cert({ value }: msgRevokeNocRootX509CertParams): EncodeObject {
			try {
				return { typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgRevokeNocRootX509Cert", value: MsgRevokeNocRootX509Cert.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgRevokeNocRootX509Cert: Could not create message: ' + e.message)
			}
		},
		...
		msgRevokeNocX509Cert({ value }: msgRevokeNocX509CertParams): EncodeObject {
			try {
				return { typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgRevokeNocX509Cert", value: MsgRevokeNocX509Cert.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgRevokeNocX509Cert: Could not create message: ' + e.message)
			}
		},
		...
		msgAddNocX509Cert({ value }: msgAddNocX509CertParams): EncodeObject {
			try {
				return { typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgAddNocX509Cert", value: MsgAddNocX509Cert.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgAddNocX509Cert: Could not create message: ' + e.message)
			}
		},
