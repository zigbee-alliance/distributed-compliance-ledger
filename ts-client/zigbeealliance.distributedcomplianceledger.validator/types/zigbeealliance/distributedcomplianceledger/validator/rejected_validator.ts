...
export const RejectedDisableValidator = {
  encode(message: RejectedDisableValidator, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.address !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RejectedDisableValidator {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRejectedDisableValidator();
  ...
  fromPartial<I extends Exact<DeepPartial<RejectedDisableValidator>, I>>(object: I): RejectedDisableValidator {
    const message = createBaseRejectedDisableValidator();
