...
export interface DistributedcomplianceledgervendorinfoVendorInfo {
  /** @format int32 */
  vendorID?: number;
  vendorName?: string;
...
export interface VendorinfoQueryAllVendorInfoResponse {
  vendorInfo?: DistributedcomplianceledgervendorinfoVendorInfo[];
...
export interface VendorinfoQueryGetVendorInfoResponse {
  vendorInfo?: DistributedcomplianceledgervendorinfoVendorInfo;
}
...
/**
 * @title zigbeealliance/distributedcomplianceledger/vendorinfo/genesis.proto
