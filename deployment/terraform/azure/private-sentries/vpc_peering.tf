...
resource "azurerm_virtual_network_peering" "this_private_sentries_to_validator_vnet_peering" {
  name                         = "private-sentries-to-validator-vnet-peering"
...
resource "azurerm_virtual_network_peering" "this_validator_to_private_sentries_vnet_peering" {
  name                         = "validator-to-private-sentries-vnet-peering"
  resource_group_name          = var.peer_vnet_resource_group_name
