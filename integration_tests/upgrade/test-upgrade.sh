...
source integration_tests/upgrade/07-test-upgrade-1.4.4-to-1.5.1.sh
source integration_tests/upgrade/08-test-upgrade-1.5.1-to-1.5.2.sh
source integration_tests/upgrade/09-test-upgrade-1.5.2-to-1.6.0.sh
source integration_tests/upgrade/10-test-upgrade-1.6.0-to-master.sh
source integration_tests/upgrade/11-test-add-new-node-after-upgrade.sh
