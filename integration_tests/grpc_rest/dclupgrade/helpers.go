...
func Demo(suite *utils.TestSuite) {
	...
	proposeUpgradeMsg := NewMsgProposeUpgrade(aliceAccount.Address, testconstants.UpgradePlanName, 100000, testconstants.UpgradePlanInfo)
...
func ProposeUpgradeByNonTrustee(suite *utils.TestSuite) {
	...
	proposeUpgradeMsg := NewMsgProposeUpgrade(nonTrusteeAccount.Address, testconstants.UpgradePlanName, 100000, testconstants.UpgradePlanInfo)
...
func ProposeUpgradeTwice(suite *utils.TestSuite) {
	...
	rejectUpgradeMsg := NewMsgRejectUpgrade(aliceAccount.Address, testconstants.UpgradePlanName)
