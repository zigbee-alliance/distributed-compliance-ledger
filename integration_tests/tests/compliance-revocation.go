...
func Compliance_revocation(){
	...
	var vendor_account string
	vendor_account = cli.Create_new_vendor_account(vendor_account,vid)

	fmt.Printf("Create CertificationCenter account")
	var zb_account string
	zb_account= cli.Create_new_account(zb_account, "CertificationCenter")

	fmt.Printf("Create other CertificationCenter account")
	var second_zb_account string
	...
	fmt.Printf("Add Model and a New Model Version with VID: " + vid + "PID: " + pid + "SV: " + sv)
