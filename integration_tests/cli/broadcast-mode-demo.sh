...
result=$(echo "test1234" | dclcli tx modelinfo add-model --vid=$vid1 --pid=$pid1 --name="Device #1" --description="Device Description" --sku="SKU12FS" --software-version="10123" --software-version-string="1.0b123"  --hardware-version="5123" --hardware-version-string="5.1.23"  --cd-version-number="32" --from=$vendor_account --yes)
...
result=$(echo "test1234" | dclcli tx modelinfo add-model --vid=$vid2 --pid=$pid2 --name="Device #2" --description="Device Description" --sku="SKU12FS" --software-version="10123" --software-version-string="1.0b123"  --hardware-version="5123" --hardware-version-string="5.1.23"  --cd-version-number="32" --from=$vendor_account --yes --broadcast-mode "async")
check_response "$result" "\"txhash\""
...
result=$(echo "test1234" | dclcli tx modelinfo add-model --vid=$vid3 --pid=$pid3 --name="Device #2" --description="Device Description" --sku="SKU12FS" --software-version="10123" --software-version-string="1.0b123"  --hardware-version="5123" --hardware-version-string="5.1.23"  --cd-version-number="32" --from=$vendor_account --yes --broadcast-mode "sync")
check_response "$result" "\"txhash\""
check_response "$result" "\"raw_log\""
check_response "$result" "\"height\": \"0\""
response_does_not_contain "$result" "\"gas_used\""
