...
echo "Add Testing Result for Model VID: $vid PID: $pid SV: $sv HV: $hv"
...
echo "Certify Model with VID: $vid PID: $pid SV: $sv HV: $hv"
certification_date="2020-01-01T00:00:00Z"
certification_type="zb"
result=$(echo "test1234" | dclcli tx compliance certify-model --vid=$vid --pid=$pid --softwareVersion=$sv --hardwareVersion=$hv --certification-type="$certification_type" --certification-date="$certification_date" --from $zb_account --yes)
check_response "$result" "\"success\": true"
echo "$result"
...
certification_date="2020-01-01T00:00:00Z"
certification_type="zb"
result=$(echo "test1234" | dclcli tx compliance certify-model --vid=$vid --pid=$pid --softwareVersion=$sv --hardwareVersion=$hv --certification-type="$certification_type" --certification-date="$certification_date" --from $second_zb_account --yes)
check_response "$result" "\"success\": false"
echo "$result"

echo "Get Certified Model with VID: ${vid} PID: ${pid}"
result=$(dclcli query compliance certified-model --vid=$vid --pid=$pid --softwareVersion=$sv --hardwareVersion=$hv --certification-type=$certification_type)
check_response "$result" "\"value\": true"
echo "$result"

echo "Get Compliance Info for Model with VID: ${vid} PID: ${pid}"
result=$(dclcli query compliance compliance-info --vid=$vid --pid=$pid --softwareVersion=$sv --hardwareVersion=$hv --certification-type=$certification_type)
...
echo "Revoke Certification for Model with VID: $vid PID: $pid SV: $sv HV: $hv"
...
result=$(dclcli query compliance revoked-model --vid=$vid --pid=$pid --softwareVersion=$sv --hardwareVersion=$hv --certification-type=$certification_type)
check_response "$result" "\"value\": true"
echo "$result"
...
echo "Again Certify Model with VID: $vid PID: $pid SV: $sv HV: $hv"
