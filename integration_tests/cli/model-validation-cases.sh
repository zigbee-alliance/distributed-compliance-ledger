...
result=$(dclcli query model get-model --vid=$vid_1 --pid=$pid_1)
...
result=$(echo "test1234" | dclcli tx model add-model --vid=$vid_1 --pid=$pid_2 --deviceTypeID=2 --productName="Test Product with All Fields" --productLabel="Test Product with All fields" \
...
# Query the model created above to see if it is added
echo "Query the model created above to see if it is added"
result=$(dclcli query model get-model --vid=$vid_1 --pid=$pid_2)
check_response_and_report "$result" "\"vid\": $vid_1"
...
result=$(echo "test1234" | dclcli tx model add-model --vid=$vid_1 --pid=$pid_3 --deviceTypeID=2 --productName="Test Product with All Fields" --productLabel="Test Product with All fields" \
--partNumber="23.456" --commissioningCustomFlow=1 --commissioningCustomFlowURL="https://customflow.url.info" \
--commissioningModeInitialStepsHint=1  --commissioningModeInitialStepsInstruction="Initial Instructions" \
--commissioningModeSecondaryStepsHint=2 --commissioningModeSecondaryStepsInstruction="Secondary Steps Instruction" \
...
# Query the model created above to see if it is added
echo "Query the model created above to see if it is added"
result=$(dclcli query model get-model --vid=$vid_1 --pid=$pid_3)
check_response_and_report "$result" "\"vid\": $vid_1"
...
result=$(echo "test1234" | dclcli tx model update-model --vid=$vid_1 --pid=$pid_1 --productName="Updated Product Name" --productLabel="Updated Test Product" --partNumber="2" --from=$vendor_account_1 --yes)
check_response "$result" "\"success\": true"
...
result=$(echo "test1234" | dclcli tx model update-model --vid=$vid_1 --pid=$pid_1  --productLabel="Updated Test Product V2" --from=$vendor_account_1 --yes)
check_response "$result" "\"success\": true"
...
result=$(echo "test1234" | dclcli tx model update-model --vid=$vid_1 --pid=$pid_1 --productName="Updated Product Name V3" \
...
result=$(echo "test1234" | dclcli tx model update-model --vid=$vid_1 --pid=$pid_1  --productLabel="Updated Test Product V4" --from=$vendor_account_1 --yes)
check_response "$result" "\"success\": true"
...
result=$(echo "test1234" | dclcli tx model update-model --vid=$vid_1 --pid=$pid_1 --from=$vendor_account_1 --yes)
check_response "$result" "\"success\": true"
...
result=$(dclcli query model get-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1)
...
result=$(echo "test1234" | dclcli tx model update-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1 --softwareVersionValid=false --from=$vendor_account_1 --yes)
check_response_and_report "$result" "\"success\": true"
...
result=$(echo "test1234" | dclcli tx model update-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1 --softwareVersionValid=true \
...
result=$(echo 'test1234' | dclcli tx model add-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1 \
...
echo "Update Device Model Version with only one mutable field and make sure all other fields are still the same for VID: $vid_1 PID: $pid_1 SV: $sv_1"
result=$(echo "test1234" | dclcli tx model update-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1 --from=$vendor_account_1 --yes)
check_response_and_report "$result" "\"success\": true"
...
result=$(echo 'test1234' | dclcli tx model update-model-version --vid=$vid_1 --pid=$pid_1 --softwareVersion=$sv_1 \
