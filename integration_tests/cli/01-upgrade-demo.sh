...
propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_2_1 --upgrade-height=$upgrade_height --upgrade-info=$upgrade_plan_info_v1_2_1 --from alice --yes)
propose=$(get_txn_result "$propose")
echo "propose upgrade response: $propose"
check_response "$propose" "\"code\": 0"
...
propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_2_2 --upgrade-height=$upgrade_height --upgrade-info=$upgrade_plan_info_v1_2_2 --from alice --yes)
propose=$(get_txn_result "$propose")
echo "propose upgrade response: $propose"
check_response "$propose" "\"code\": 0"

approve=$(dcld tx dclupgrade approve-upgrade --name=$upgrade_plan_name_v1_2_2 --from bob --yes)
approve=$(get_txn_result "$approve")
echo "approve upgrade response: $approve"
check_response "$approve" "\"code\": 0"

second_approve=$(dcld tx dclupgrade approve-upgrade --name=$upgrade_plan_name_v1_2_2 --from bob --yes)
...
propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_4_0 --upgrade-height=$upgrade_height --upgrade-info=$upgrade_plan_info_v1_4_0 --from alice --yes)
propose=$(get_txn_result "$propose")
echo "propose upgrade response: $propose"
check_response "$propose" "\"code\": 0"

second_propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_4_0 --upgrade-height=$upgrade_height --upgrade-info=$upgrade_plan_info_v1_4_0 --from alice --yes)
...
height=1
propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_4_0 --upgrade-height=$height --upgrade-info=$upgrade_plan_info_v1_4_0 --from alice --yes)
propose=$(get_txn_result "$propose")
echo "propose upgrade response: $propose"
...
upgrade_height=$(($RANDOM + 10000000))
propose=$(dcld tx dclupgrade propose-upgrade --name=$upgrade_plan_name_v1_4_1 --upgrade-height=$upgrade_height --upgrade-info=$upgrade_plan_info_v1_4_1 --from $trustee_account --yes)
propose=$(get_txn_result "$propose")
echo "propose upgrade response: $propose"
check_response "$propose" "\"code\": 0"

approve=$(dcld tx dclupgrade approve-upgrade --name=$upgrade_plan_name_v1_4_1 --from alice --yes)
approve=$(get_txn_result "$approve")
echo "approve upgrade response: $approve"
check_response "$approve" "\"code\": 0"

proposed_dclupgrade_query=$(dcld query dclupgrade proposed-upgrade --name=$upgrade_plan_name_v1_4_1)
echo "dclupgrade proposed upgrade query: $proposed_dclupgrade_query"
check_response_and_report "$proposed_dclupgrade_query" "\"name\": \"$upgrade_plan_name_v1_4_1\""
check_response_and_report "$proposed_dclupgrade_query" "\"height\": \"$upgrade_height\""
check_upgrade_plan_info "$proposed_dclupgrade_query" "$upgrade_plan_info_v1_4_1"

reject=$(dcld tx dclupgrade reject-upgrade --name=$upgrade_plan_name_v1_4_1 --from $trustee_account --yes)
reject=$(get_txn_result "$reject")
echo "reject upgrade response: $reject"
check_response "$reject" "\"code\": 0"

approve=$(dcld tx dclupgrade approve-upgrade --name=$upgrade_plan_name_v1_4_1 --from $trustee_account --yes)
approve=$(get_txn_result "$approve")
echo "approve upgrade response: $approve"
check_response "$approve" "\"code\": 0"

reject=$(dcld tx dclupgrade reject-upgrade --name=$upgrade_plan_name_v1_4_1 --from alice --yes)
reject=$(get_txn_result "$reject")
echo "reject upgrade response: $reject"
check_response "$reject" "\"code\": 0"

# second_reject=$(dcld tx dclupgrade reject-upgrade ---name=$upgrade_plan_name_v1_4_1 --from alice --yes)
...
rejected_dclupgrade_query=$(dcld query dclupgrade rejected-upgrade --name=$upgrade_plan_name_v1_4_1)
echo "dclupgrade rejected upgrade query: $rejected_dclupgrade_query"
check_response "$rejected_dclupgrade_query" "Not Found"

approved_dclupgrade_query=$(dcld query dclupgrade approved-upgrade --name=$upgrade_plan_name_v1_4_1)
echo "dclupgrade approved upgrade query: $approved_dclupgrade_query"
check_response "$approved_dclupgrade_query" "Not Found"

reject=$(dcld tx dclupgrade reject-upgrade --name=$upgrade_plan_name_v1_4_1 --from bob --yes)
reject=$(get_txn_result "$reject")
echo "reject upgrade response: $reject"
check_response "$reject" "\"code\": 0"
...
rejected_dclupgrade_query=$(dcld query dclupgrade rejected-upgrade --name=$upgrade_plan_name_v1_4_1)
echo "dclupgrade rejected upgrade query: $rejected_dclupgrade_query"
check_response_and_report "$rejected_dclupgrade_query" "\"name\": \"$upgrade_plan_name_v1_4_1\""
check_response_and_report "$rejected_dclupgrade_query" "\"height\": \"$upgrade_height\""
check_upgrade_plan_info "$rejected_dclupgrade_query" "$upgrade_plan_info_v1_4_1"
