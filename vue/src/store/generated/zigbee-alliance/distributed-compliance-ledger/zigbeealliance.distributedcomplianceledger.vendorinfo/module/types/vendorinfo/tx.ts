...
const baseMsgCreateVendorInfo: object = { creator: '', vendorID: 0, vendorName: '', companyLegalName: '', companyPrefferredName: '', vendorLandingPageURL: '' }
...
export const MsgCreateVendorInfo = {
  encode(message: MsgCreateVendorInfo, writer: Writer = Writer.create()): Writer {
    ...
    if (message.companyPrefferredName !== '') {
      writer.uint32(42).string(message.companyPrefferredName)
    }
...
const baseMsgUpdateVendorInfo: object = { creator: '', vendorID: 0, vendorName: '', companyLegalName: '', companyPrefferredName: '', vendorLandingPageURL: '' }
