...
const baseVendorInfoType: object = { vendorID: 0, vendorName: '', companyLegalName: '', companyPrefferedName: '', vendorLandingPageURL: '', creator: '' }

export const VendorInfoType = {
  encode(message: VendorInfoType, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): VendorInfoType {
    ...
    const message = { ...baseVendorInfoType } as VendorInfoType
