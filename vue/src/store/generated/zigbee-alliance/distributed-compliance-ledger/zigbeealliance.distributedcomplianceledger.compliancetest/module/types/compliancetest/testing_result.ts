...
const baseTestingResult: object = { vid: 0, pid: 0, softwareVersion: 0, softwareVersionString: '', owner: '', testResult: '', testDate: '' }

export const TestingResult = {
  encode(message: TestingResult, writer: Writer = Writer.create()): Writer {
    if (message.vid !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): TestingResult {
    ...
    const message = { ...baseTestingResult } as TestingResult
