...
const baseCertifiedModel: object = { vid: 0, pid: 0, softwareVersion: 0, certificationType: '', value: false }

export const CertifiedModel = {
  encode(message: CertifiedModel, writer: Writer = Writer.create()): Writer {
    if (message.vid !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): CertifiedModel {
    ...
    const message = { ...baseCertifiedModel } as CertifiedModel
