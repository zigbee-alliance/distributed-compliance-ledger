...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgApproveAddX509RootCert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgApproveAddX509RootCert", value: data }),
        msgProposeRevokeX509RootCert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgProposeRevokeX509RootCert", value: data }),
        msgRevokeX509Cert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgRevokeX509Cert", value: data }),
        msgAddX509Cert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgAddX509Cert", value: data }),
        msgProposeAddX509RootCert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgProposeAddX509RootCert", value: data }),
        msgApproveRevokeX509RootCert: (data) => ({ typeUrl: "/zigbeealliance.distributedcomplianceledger.pki.MsgApproveRevokeX509RootCert", value: data }),
    };
};
