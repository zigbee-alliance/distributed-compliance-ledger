...
declare const txClient: (wallet: OfflineSigner, { addr: addr }?: TxClientOptions) => Promise<{
    ...
    msgDeletePkiRevocationDistributionPoint: (data: MsgDeletePkiRevocationDistributionPoint) => EncodeObject;
    ...
    msgAddPkiRevocationDistributionPoint: (data: MsgAddPkiRevocationDistributionPoint) => EncodeObject;
    ...
    msgUpdatePkiRevocationDistributionPoint: (data: MsgUpdatePkiRevocationDistributionPoint) => EncodeObject;
}>;
