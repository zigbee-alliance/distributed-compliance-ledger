...
type MsgCreateVendorInfo struct {
	...
	VendorName           string `protobuf:"bytes,3,opt,name=vendor_name,json=vendorName,proto3" json:"vendor_name,omitempty" validate:"required,max=128"`
	CompanyLegalName     string `protobuf:"bytes,4,opt,name=company_legal_name,json=companyLegalName,proto3" json:"company_legal_name,omitempty" validate:"required,max=256"`
	CompanyPrefferedName string `protobuf:"bytes,5,opt,name=company_preffered_name,json=companyPrefferedName,proto3" json:"company_preffered_name,omitempty" validate:"omitempty,max=256"`
	VendorLandingPageUrl string `protobuf:"bytes,6,opt,name=vendor_landing_page_url,json=vendorLandingPageUrl,proto3" json:"vendor_landing_page_url,omitempty" validate:"omitempty,max=256,url"`
}
...
func (m *MsgCreateVendorInfo) GetVid() int32 {
	if m != nil {
		return m.Vid
	}
	return 0
...
func (m *MsgUpdateVendorInfo) GetVid() int32 {
	if m != nil {
		return m.Vid
	}
	return 0
...
var fileDescriptor_193d895112924f09 = []byte{
	...
	,
}
