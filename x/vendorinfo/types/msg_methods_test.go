...
func TestVendorinfoMsgMethods(t *testing.T) {
	creator := sample.AccAddress()
	msgs := []legacyMsg{
		&MsgCreateVendorInfo{Creator: creator},
...
func TestVendorinfoMsgGetSignersPanicsOnInvalidSigner(t *testing.T) {
	msgs := []legacyMsg{
		&MsgCreateVendorInfo{Creator: "invalid"},
		&MsgUpdateVendorInfo{Creator: "invalid"},
	}
	for _, msg := range msgs {
		t.Run(msg.Type(), func(t *testing.T) {
