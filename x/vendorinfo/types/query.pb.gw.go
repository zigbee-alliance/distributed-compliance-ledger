...
var (
	pattern_Query_VendorInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"zigbee-alliance", "distributedcomplianceledger", "vendorinfo", "vendorInfo", "vendorID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VendorInfoAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zigbee-alliance", "distributedcomplianceledger", "vendorinfo", "vendorInfo"}, "", runtime.AssumeColonVerbOpt(true)))
)
