...
func decodeStd(t *testing.T, pemCert string) *x509std.Certificate {
	t.Helper()
...
func removeExt(cert *x509std.Certificate, oid asn1.ObjectIdentifier) {
...
func setExtCriticalFlag(cert *x509std.Certificate, oid asn1.ObjectIdentifier, critical bool) {
...
func TestVerifyEndEntityExtensions_NegativeBranches(t *testing.T) {
	base := func(t *testing.T) *x509std.Certificate {
		t.Helper()
