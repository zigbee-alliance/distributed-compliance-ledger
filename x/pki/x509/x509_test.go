...
func Test_DecodeCertificates(t *testing.T) {
	...
	require.Equal(t, testconstants.IntermediateSubjectAsText, certificate.Issuer)
	...
	require.Nil(t, err)
	require.False(t, certificate.IsSelfSigned())
	require.Equal(t, testconstants.RootSubjectAsText, certificate.Issuer)
...
func Test_DecodeCertificatesWithVID(t *testing.T) {
	...
	require.Nil(t, err)
	require.True(t, certificate.IsSelfSigned())
	require.Equal(t, testconstants.GoogleSubjectAsText, certificate.Issuer)
	...
	require.Nil(t, err)
	require.True(t, certificate.IsSelfSigned())
	require.Equal(t, testconstants.TestSubjectAsText, certificate.Issuer)
