...
var fileDescriptor_59301d987fd5414e = []byte{
	...
	0x08, 0xc4, 0x04, 0xa5, 0xfb, 0x8c, 0x5c, 0x42, 0x7e, 0xf9, 0xc9, 0x9e, 0xc9, 0x89, 0xce, 0x48,
	...
	0x35, 0x89, 0x1e, 0xd4, 0x43, 0xb2, 0x3e, 0x08, 0x62, 0x92, 0x90, 0x0b, 0x17, 0x6f, 0x71, 0x72,
	0x46, 0x6a, 0x6e, 0x62, 0x58, 0x6a, 0x51, 0x71, 0x66, 0x7e, 0x9e, 0x04, 0xb3, 0x02, 0xa3, 0x06,
	0x2f, 0x36, 0xe7, 0x18, 0x20, 0x3b, 0x07, 0x55, 0x93, 0x53, 0xdc, 0x89, 0x47, 0x72, 0x8c, 0x17,
	...
	0xea, 0x43, 0x5c, 0xab, 0x8b, 0x2d, 0x24, 0x75, 0x11, 0xee, 0xd5, 0x85, 0x86, 0x65, 0x05, 0x38,
	0x34, 0x4b, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x01, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0xfc, 0xea, 0x6c, 0x64, 0x1d, 0x02, 0x00, 0x00,
}
...
func (m *NocIcaCertificates) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SchemaVersion != 0 {
		i = encodeVarintNocIcaCertificates(dAtA, i, uint64(m.SchemaVersion))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Certs) > 0 {
...
func (m *NocIcaCertificates) Size() (n int) {
	...
	if m.SchemaVersion != 0 {
		n += 1 + sovNocIcaCertificates(uint64(m.SchemaVersion))
	}
	return n
}
