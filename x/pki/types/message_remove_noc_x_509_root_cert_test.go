...
func TestMsgRemoveNocX509RootCert_ValidateBasic(t *testing.T) {
	negativeTests := []struct {
		name string
		msg  MsgRemoveNocX509RootCert
		err  error
	}{
		{
	...
	positiveTests := []struct {
		...
		{
			name: "valid remove nocX509RootCert msg",
			msg: MsgRemoveNocX509RootCert{
				Signer:       sample.AccAddress(),
				Subject:      testconstants.RootSubject,
				SubjectKeyId: testconstants.RootSubjectKeyID,
		...
		{
			name: "valid remove nocX509RootCert msg with serial number",
			msg: MsgRemoveNocX509RootCert{
				Signer:       sample.AccAddress(),
				Subject:      testconstants.RootSubject,
				SubjectKeyId: testconstants.RootSubjectKeyID,
