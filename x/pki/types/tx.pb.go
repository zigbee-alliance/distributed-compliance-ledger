...
type MsgApproveAddX509RootCert struct {
	...
	SubjectAsText string `protobuf:"bytes,6,opt,name=subjectAsText,proto3" json:"subjectAsText,omitempty" validate:"required,max=1024"`
}
...
func (m *MsgApproveAddX509RootCert) GetSubjectAsText() string {
	if m != nil {
...
func (m *MsgProposeRevokeX509RootCert) GetSubjectAsText() string {
	if m != nil {
		return m.SubjectAsText
	}
	return ""
...
type MsgApproveRevokeX509RootCert struct {
	...
	SubjectAsText string `protobuf:"bytes,7,opt,name=subjectAsText,proto3" json:"subjectAsText,omitempty" validate:"required,max=1024"`
}
...
func (m *MsgApproveRevokeX509RootCert) GetSubjectAsText() string {
	if m != nil {
		return m.SubjectAsText
	}
	return ""
...
func (m *MsgRevokeX509Cert) GetSubjectAsText() string {
	if m != nil {
		return m.SubjectAsText
	}
	return ""
...
var fileDescriptor_badfdb2b39855d16 = []byte{
	...
	,
}
...
func (m *MsgApproveAddX509RootCert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubjectAsText) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.SubjectAsText)))
		i--
		dAtA[i] = 0x32
	}
	if m.Time != 0 {
