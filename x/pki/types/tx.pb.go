...
type MsgProposeAddX509RootCert struct {
	...
	Cert   string `protobuf:"bytes,2,opt,name=cert,proto3" json:"cert,omitempty" validate:"required,max=3500000"`
}
...
type MsgApproveAddX509RootCert struct {
	Signer       string `protobuf:"bytes,1,opt,name=signer,proto3" json:"signer,omitempty" validate:"required"`
	Subject      string `protobuf:"bytes,2,opt,name=subject,proto3" json:"subject,omitempty" validate:"required,max=50"`
	SubjectKeyId string `protobuf:"bytes,3,opt,name=subject_key_id,json=subjectKeyId,proto3" json:"subject_key_id,omitempty" validate:"required,max=150"`
}
...
var fileDescriptor_badfdb2b39855d16 = []byte{
	...
	,
}
