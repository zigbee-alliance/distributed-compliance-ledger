...
func TestGenesisState_Validate(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			genState: &types.GenesisState{
				ApprovedCertificatesList: []types.ApprovedCertificates{
					{Subject: "0", SubjectKeyId: "0"},
					{Subject: "1", SubjectKeyId: "1"},
				},
				...
				ChildCertificatesList: []types.ChildCertificates{
					{Issuer: "0", AuthorityKeyId: "0"},
					{Issuer: "1", AuthorityKeyId: "1"},
				},
				...
				UniqueCertificateList: []types.UniqueCertificate{
					{Issuer: "0", SerialNumber: "0"},
					{Issuer: "1", SerialNumber: "1"},
				},
		...
		},
		{
			...
			genState: &types.GenesisState{
				ProposedCertificateRevocationList: []types.ProposedCertificateRevocation{
					{Subject: "0", SubjectKeyId: "0", SerialNumber: "0"},
					{Subject: "0", SubjectKeyId: "0", SerialNumber: "0"},
				},
			},
			valid: false,
		...
		},
		{
			...
			genState: &types.GenesisState{
				PkiRevocationDistributionPointList: []types.PkiRevocationDistributionPoint{
					{Vid: 0, Label: "0", IssuerSubjectKeyID: "0"},
					{Vid: 0, Label: "0", IssuerSubjectKeyID: "0"},
				},
			},
			valid: false,
		...
		{
			desc: "duplicated approvedCertificatesBySubjectKeyId",
			genState: &types.GenesisState{
		...
		{
			desc: "duplicated nocIcaCertificates",
			genState: &types.GenesisState{
