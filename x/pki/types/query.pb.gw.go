...
var (
	...
	pattern_Query_ApprovedRootCertificates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dcl", "pki", "approved_root_certificates"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RevokedRootCertificates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dcl", "pki", "revoked_root_certificates"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ApprovedCertificatesBySubject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"dcl", "pki", "approved_certificates_by_subject", "subject"}, "", runtime.AssumeColonVerbOpt(true)))
)
