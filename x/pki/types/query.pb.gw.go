...
var (
	...
	pattern_Query_PKIRevocationDistributionPoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"dcl", "pki", "pki_revocation_distribution_point", "vid", "label", "issuerSubjectKeyID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PKIRevocationDistributionPointAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"dcl", "pki", "pki_revocation_distribution_point"}, "", runtime.AssumeColonVerbOpt(false)))
)
