...
var (
	...
	pattern_Query_RejectedCertificate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"zigbee-alliance", "distributedcomplianceledger", "pki", "rejected_certificate", "subject", "subjectKeyId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RejectedCertificateAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zigbee-alliance", "distributedcomplianceledger", "pki", "rejected_certificate"}, "", runtime.AssumeColonVerbOpt(true)))
)
