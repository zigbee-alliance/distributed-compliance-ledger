...
func (m *RevokedCertificates) GetCerts() []string {
	if m != nil {
		return m.Certs
	}
	return nil
...
var fileDescriptor_cca42ddac598ffcf = []byte{
	...
	,
}
...
func (m *RevokedCertificates) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Certs) > 0 {
		for iNdEx := len(m.Certs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRevokedCertificates(dAtA, i, uint64(len(m.Certs[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
