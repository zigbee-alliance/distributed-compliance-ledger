...
func CmdProposeRevokeX509RootCert() *cobra.Command {
	...
	cmd.Flags().StringP(FlagRevokeChild, FlagRevokeChildShortcut, "", "If true, all certificates in the chain signed by the revoked certificate are revoked as well (default false)")
