...
func CmdAddPkiRevocationDistributionPoint() *cobra.Command {
	...
	cmd.Flags().StringVar(&dataURL, FlagDataURL, "", "The URL where to obtain the information in the format indicated by the RevocationType field. Must start with either http or https. Maximum 256 characters; must be unique for all pairs of VendorID and IssuerSubjectKeyID.")
