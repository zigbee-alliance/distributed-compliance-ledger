...
func TestHandler_AddX509Cert(t *testing.T) {
	...
	addX509Cert := types.NewMsgAddX509Cert(accAddress.String(), testconstants.IntermediateCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	...
	for _, cert := range certs {
		...
		require.Equal(t, testconstants.SchemaVersion, cert.SchemaVersion)
...
func TestHandler_AddX509Cert_ForInvalidCertificate(t *testing.T) {
	...
	// add x509 certificate
	addX509Cert := types.NewMsgAddX509Cert(accAddress.String(), testconstants.StubCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
...
func TestHandler_AddX509Cert_ForRootCertificate(t *testing.T) {
	...
	addX509Cert := types.NewMsgAddX509Cert(accAddress.String(), testconstants.RootCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
...
func TestHandler_AddX509Cert_ForExistingNocCertificate(t *testing.T) {
	...
	setup.Keeper.AddApprovedCertificate(setup.Ctx, nocCertificate, testconstants.SchemaVersion)
	setup.Keeper.AddNocIcaCertificate(setup.Ctx, nocCertificate, testconstants.SchemaVersion)
...
func TestHandler_AddX509Cert_NoRootCert(t *testing.T) {
	...
	setup.Keeper.AddApprovedCertificate(setup.Ctx, intermediateCertificate, testconstants.SchemaVersion)

	// add leaf x509 certificate
	addX509Cert := types.NewMsgAddX509Cert(vendorAccAddress.String(), testconstants.LeafCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
	require.ErrorIs(t, err, pkitypes.ErrInvalidCertificate)
}
...
func TestHandler_AddX509Cert_RootIsNoc(t *testing.T) {
	...
	addNocX509RootCert := types.NewMsgAddNocX509RootCert(accAddress.String(), testconstants.RootCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
...
func TestHandler_AddX509Cert_ForFailedCertificateVerification(t *testing.T) {
	...
	setup.Keeper.AddApprovedCertificate(setup.Ctx, invalidRootCertificate, testconstants.SchemaVersion)
...
func TestHandler_AddX509Cert_EachChildCertRefersToTwoParentCerts(t *testing.T) {
	...
	setup.Keeper.AddApprovedCertificate(setup.Ctx, rootCert, testconstants.SchemaVersion)
...
func TestHandler_AddX509Cert_ByNotOwnerButSameVendor(t *testing.T) {
	...
	addX509Cert := types.NewMsgAddX509Cert(vendorAccAddress2.String(), testconstants.IntermediateCertPem, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
	require.NoError(t, err)
}
...
func TestHandler_AddX509Cert_SenderNotVendor(t *testing.T) {
	...
	// add x509 certificate
	addX509Cert := types.NewMsgAddX509Cert(setup.Trustee1.String(), testconstants.IntermediateCertWithVid1, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
	require.ErrorIs(t, err, sdkerrors.ErrUnauthorized)
}
...
func TestHandler_AddX509Cert_VIDScopedRoot(t *testing.T) {
	...
	// add x509 certificate
	addX509Cert := types.NewMsgAddX509Cert(accAddress.String(), testconstants.PAICertWithNumericPidVid, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
	_, err := setup.Handler(setup.Ctx, addX509Cert)
	require.NoError(t, err)
...
func TestHandler_AddX509Cert_NonVIDScopedRoot(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// add x509 certificate
			addX509Cert := types.NewMsgAddX509Cert(accAddress.String(), tc.childCert, testconstants.CertSchemaVersion, testconstants.SchemaVersion)
			_, err := setup.Handler(setup.Ctx, addX509Cert)
			require.NoError(t, err)
