...
func TestQuerier_QueryTestingResult(t *testing.T) {
	...
	result, _ := setup.Querier(
		setup.Ctx,
		[]string{
			QueryTestingResult, fmt.Sprintf("%v", testingResult.VID), fmt.Sprintf("%v", testingResult.PID),
			fmt.Sprintf("%v", testingResult.SoftwareVersion), fmt.Sprintf("%v", testingResult.HardwareVersion),
		},
		abci.RequestQuery{},
	)
	...
	require.Equal(t, receivedTestingResult.HardwareVersion, testingResult.HardwareVersion)
...
func TestQuerier_QueryTestingResultForUnknown(t *testing.T) {
	...
	_, err := setup.Querier(
		setup.Ctx,
		[]string{
			QueryTestingResult, fmt.Sprintf("%v", test_constants.VID), fmt.Sprintf("%v", test_constants.PID),
			fmt.Sprintf("%v", test_constants.SoftwareVersion), fmt.Sprintf("%v", test_constants.HardwareVersion),
		},
		abci.RequestQuery{},
	)
