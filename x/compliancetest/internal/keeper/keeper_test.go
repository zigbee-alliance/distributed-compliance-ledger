...
func TestKeeper_TestingResultGetSet(t *testing.T) {
	...
	require.False(t, setup.CompliancetestKeeper.IsTestingResultsPresents(
		setup.Ctx, testconstants.VID, testconstants.PID, testconstants.SoftwareVersion, testconstants.HardwareVersion))
	...
	require.Equal(t, receivedTestingResult.HardwareVersion, testconstants.HardwareVersion)
