...
func NewTestingResult(vid uint16, pid uint16,
	...
	owner sdk.AccAddress, testResult string, testDate time.Time) TestingResult {
...
func NewTestingResults(vid uint16, pid uint16, softwareVersion uint32, hardwareVersion uint32) TestingResults {
