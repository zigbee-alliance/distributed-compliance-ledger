...
// source: zigbeealliance/distributedcomplianceledger/dclauth/pending_account.proto
...
type PendingAccount struct {
	*Account                    `protobuf:"bytes,1,opt,name=account,proto3,embedded=account" json:"account,omitempty"`
	PendingAccountSchemaVersion uint32 `protobuf:"varint,2,opt,name=pendingAccountSchemaVersion,proto3" json:"pendingAccountSchemaVersion,omitempty"`
}
...
func (*PendingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_0beda4bc7537ece0, []int{0}
}
...
func (m *PendingAccount) GetPendingAccountSchemaVersion() uint32 {
	if m != nil {
		return m.PendingAccountSchemaVersion
	}
	return 0
}
...
func init() {
	proto.RegisterFile("zigbeealliance/distributedcomplianceledger/dclauth/pending_account.proto", fileDescriptor_0beda4bc7537ece0)
}

var fileDescriptor_0beda4bc7537ece0 = []byte{
	// 262 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xf2, 0xa8, 0xca, 0x4c, 0x4f,
	...
	,
}
...
func (m *PendingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PendingAccountSchemaVersion != 0 {
		i = encodeVarintPendingAccount(dAtA, i, uint64(m.PendingAccountSchemaVersion))
		i--
		dAtA[i] = 0x10
	}
	if m.Account != nil {
...
func (m *PendingAccount) Size() (n int) {
	...
	if m.PendingAccountSchemaVersion != 0 {
		n += 1 + sovPendingAccount(uint64(m.PendingAccountSchemaVersion))
	}
	return n
}
...
func (m *PendingAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingAccountSchemaVersion", wireType)
			}
			m.PendingAccountSchemaVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPendingAccount
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PendingAccountSchemaVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
