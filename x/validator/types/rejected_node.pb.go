...
func (m *RejectedNode) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *RejectedNode) GetApprovals() []string {
	if m != nil {
		return m.Approvals
	}
	return nil
...
var fileDescriptor_52c046860a4f93c9 = []byte{
	...
	0x4c, 0x49, 0x2c, 0xc9, 0x2f, 0xd2, 0x2f, 0x4a, 0xcd, 0x4a, 0x4d, 0x2e, 0x49, 0x4d, 0x89, 0xcf,
	0xcb, 0x4f, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x32, 0xa9, 0xca, 0x4c, 0x4f, 0x4a,
	...
	,
}
...
func (m *RejectedNode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Approvals) > 0 {
		for iNdEx := len(m.Approvals) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRejectedNode(dAtA, i, uint64(len(m.Approvals[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Owner) > 0 {
		i -= len(m.Owner)
		copy(dAtA[i:], m.Owner)
		i = encodeVarintRejectedNode(dAtA, i, uint64(len(m.Owner)))
		i--
		dAtA[i] = 0xa
	}
