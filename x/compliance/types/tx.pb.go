...
type MsgCertifyModel struct {
	...
	ProgramTypeVersion                 string `protobuf:"bytes,10,opt,name=programTypeVersion,proto3" json:"programTypeVersion,omitempty" validate:"max=64"` // Deprecated: Do not use.
...
type MsgUpdateComplianceInfo struct {
	...
	ProgramTypeVersion                 string `protobuf:"bytes,13,opt,name=programTypeVersion,proto3" json:"programTypeVersion,omitempty" validate:"omitempty,max=64"`             // Deprecated: Do not use.
...
var fileDescriptor_631265d620e99057 = []byte{
	...
	,
}
