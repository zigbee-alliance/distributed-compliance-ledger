...
type MsgCertifyModel struct {
	...
	SchemaVersion                      uint32 `protobuf:"varint,22,opt,name=schemaVersion,proto3" json:"schemaVersion,omitempty" validate:"eq=1"`
...
type MsgRevokeModel struct {
	...
	CertificationType     string `protobuf:"bytes,8,opt,name=certificationType,proto3" json:"certificationType,omitempty" validate:"required,max=20"`
	Reason                string `protobuf:"bytes,9,opt,name=reason,proto3" json:"reason,omitempty" validate:"max=20480"`
	SchemaVersion         uint32 `protobuf:"varint,10,opt,name=schemaVersion,proto3" json:"schemaVersion,omitempty" validate:"eq=1"`
}
...
var fileDescriptor_631265d620e99057 = []byte{
	...
	,
}
