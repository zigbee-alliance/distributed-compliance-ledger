...
type MsgCertifyModel struct {
	...
	OSNameAndVersion                   string `protobuf:"bytes,16,opt,name=OSNameAndVersion,proto3" json:"OSNameAndVersion,omitempty" validate:"max=64"`
...
func (m *MsgCertifyModel) GetOSNameAndVersion() string {
	if m != nil {
		return m.OSNameAndVersion
	}
	return ""
}
...
func (m *MsgProvisionModel) GetOSNameAndVersion() string {
	if m != nil {
		return m.OSNameAndVersion
	}
	return ""
...
type MsgUpdateComplianceInfo struct {
	...
	OSNameAndVersion                   string `protobuf:"bytes,19,opt,name=OSNameAndVersion,proto3" json:"OSNameAndVersion,omitempty" validate:"omitempty,max=64"`
...
func (m *MsgUpdateComplianceInfo) GetOSNameAndVersion() string {
	if m != nil {
		return m.OSNameAndVersion
	}
	return ""
...
var fileDescriptor_631265d620e99057 = []byte{
	...
	,
}
...
func (m *MsgCertifyModel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OSNameAndVersion) > 0 {
		i -= len(m.OSNameAndVersion)
		copy(dAtA[i:], m.OSNameAndVersion)
		i = encodeVarintTx(dAtA, i, uint64(len(m.OSNameAndVersion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (m *MsgCertifyModel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OSNameAndVersion", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OSNameAndVersion = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 17:
			if wireType != 2 {
