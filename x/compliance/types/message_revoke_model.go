...
func NewMsgRevokeModel(signer string, vid int32, pid int32, softwareVersion uint64, softwareVersionString string, revocationDate string, certificationType string, reason string) *MsgRevokeModel {
