...
func TestMsgCertifyModel_ValidateBasic(t *testing.T) {
	negativeTests := []struct {
		...
		{
			name: "certificationTypeVersion > 64",
			msg: MsgCertifyModel{
				Signer:                   sample.AccAddress(),
				Pid:                      1,
				Vid:                      1,
				...
				Reason:                   testconstants.Reason,
				CDCertificateId:          testconstants.CDCertificateID,
				CertificationTypeVersion: tmrand.Str(65),
			},
			err: validator.ErrFieldMaxLengthExceeded,
		},
		{
	...
	positiveTests := []struct {
		...
		{
			name: "CertificationTypeVersion >= 0 && CertificationTypeVersion <= 64",
			msg: MsgCertifyModel{
				Signer:                   sample.AccAddress(),
				Pid:                      1,
				Vid:                      1,
		...
		{
			name: "OSNameAndVersion >= 0 && OSNameAndVersion <= 64",
			msg: MsgCertifyModel{
				Signer:                sample.AccAddress(),
				Pid:                   1,
				Vid:                   1,
