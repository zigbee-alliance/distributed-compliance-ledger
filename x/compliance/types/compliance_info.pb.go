...
// source: zigbeealliance/distributedcomplianceledger/compliance/compliance_info.proto
...
type ComplianceInfo struct {
	...
	ProductType                        string                   `protobuf:"bytes,14,opt,name=productType,proto3" json:"productType,omitempty"`
	CertificationTypeVersion           string                   `protobuf:"bytes,15,opt,name=certificationTypeVersion,proto3" json:"certificationTypeVersion,omitempty"`
	...
	OSNameAndVersion                   string                   `protobuf:"bytes,21,opt,name=OSNameAndVersion,proto3" json:"OSNameAndVersion,omitempty"`
...
func (*ComplianceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b59222752039640e, []int{0}
}
...
func (m *ComplianceInfo) GetProductType() string {
	if m != nil {
...
func (m *ComplianceInfo) GetCertificationTypeVersion() string {
	if m != nil {
...
func (m *ComplianceInfo) GetOSNameAndVersion() string {
	if m != nil {
...
func (m *ComplianceInfo) GetSchemaVersion() uint32 {
	if m != nil {
...
func init() {
	proto.RegisterFile("zigbeealliance/distributedcomplianceledger/compliance/compliance_info.proto", fileDescriptor_b59222752039640e)
}

var fileDescriptor_b59222752039640e = []byte{
	// 606 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ComplianceInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OSNameAndVersion) > 0 {
		...
		i = encodeVarintComplianceInfo(dAtA, i, uint64(len(m.OSNameAndVersion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if len(m.CertificationTypeVersion) > 0 {
		...
		i = encodeVarintComplianceInfo(dAtA, i, uint64(len(m.CertificationTypeVersion)))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.ProductType) > 0 {
		...
		i = encodeVarintComplianceInfo(dAtA, i, uint64(len(m.ProductType)))
		i--
		dAtA[i] = 0x72
	}
