...
func TestNewMsgCertifyModel(t *testing.T) {
	msg := NewMsgCertifyModel(testconstants.VID, testconstants.PID,
		testconstants.SoftwareVersion, testconstants.HardwareVersion, testconstants.CertificationDate,
...
func TestMsgCertifyModelValidation(t *testing.T) {
	cases := []struct {
		...
		{false, NewMsgCertifyModel(
			testconstants.VID, testconstants.PID, testconstants.SoftwareVersion,
			testconstants.HardwareVersion, time.Time{},
			CertificationType(testconstants.CertificationType), testconstants.Reason, testconstants.Signer)},
		{false, NewMsgCertifyModel(
			testconstants.VID, testconstants.PID, testconstants.SoftwareVersion,
			testconstants.HardwareVersion, testconstants.CertificationDate,
...
func TestMsgCertifyModelGetSignBytes(t *testing.T) {
	msg := NewMsgCertifyModel(testconstants.VID, testconstants.PID, testconstants.SoftwareVersion,
		testconstants.HardwareVersion, testconstants.CertificationDate,
	...
	expected := `{"type":"compliance/CertifyModel","value":{"certification_date":"2020-01-01T00:00:00Z",` +
		`"certification_type":"zb","hardwareVersion":21,"pid":22,` +
		`"signer":"cosmos1p72j8mgkf39qjzcmr283w8l8y9qv30qpj056uz","softwareVersion":1,"vid":1}}`

	require.Equal(t, expected, string(msg.GetSignBytes()))
}

func TestNewMsgRevokeModel(t *testing.T) {
	msg := NewMsgRevokeModel(testconstants.VID, testconstants.PID,
		testconstants.SoftwareVersion, testconstants.HardwareVersion, testconstants.RevocationDate,
...
func TestMsgRevokeModelValidation(t *testing.T) {
	cases := []struct {
		...
		{true, NewMsgRevokeModel(
			testconstants.VID, testconstants.PID, testconstants.SoftwareVersion,
			testconstants.HardwareVersion, testconstants.RevocationDate,
			CertificationType(testconstants.CertificationType), testconstants.RevocationReason, testconstants.Signer)},
		{false, NewMsgRevokeModel(
			0, testconstants.PID, testconstants.SoftwareVersion, testconstants.HardwareVersion, testconstants.RevocationDate,
			CertificationType(testconstants.CertificationType), testconstants.RevocationReason, testconstants.Signer)},
		{false, NewMsgRevokeModel(
			testconstants.VID, 0, testconstants.SoftwareVersion, testconstants.HardwareVersion, testconstants.RevocationDate,
			CertificationType(testconstants.CertificationType), testconstants.RevocationReason, testconstants.Signer)},
		{false, NewMsgRevokeModel(
			testconstants.VID, testconstants.PID, testconstants.SoftwareVersion, testconstants.HardwareVersion, time.Time{},
			CertificationType(testconstants.CertificationType), testconstants.RevocationReason, testconstants.Signer)},
		{true, NewMsgRevokeModel(
			testconstants.VID, testconstants.PID, testconstants.SoftwareVersion,
			testconstants.HardwareVersion, testconstants.RevocationDate,
...
func TestMsRevokeModelGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"compliance/RevokeModel","value":{"certification_type":"zb",` +
		`"hardwareVersion":21,"pid":22,"reason":"Some Reason","revocation_date":"2020-03-03T03:30:00Z",` +
		`"signer":"cosmos1p72j8mgkf39qjzcmr283w8l8y9qv30qpj056uz","softwareVersion":1,"vid":1}}`
	require.Equal(t, expected, string(msg.GetSignBytes()))
}
