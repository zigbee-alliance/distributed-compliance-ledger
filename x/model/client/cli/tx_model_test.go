...
func TestCreateModel(t *testing.T) {
	...
	fields := []string{
		...
		fmt.Sprintf("--%s=%v", cli.FlagIcdUserActiveModeTriggerHint, testconstants.IcdUserActiveModeTriggerHint),
		fmt.Sprintf("--%s=%v", cli.FlagIcdUserActiveModeTriggerInstruction, testconstants.IcdUserActiveModeTriggerInstruction),
		...
		fmt.Sprintf("--%s=%v", cli.FlagEnhancedSetupFlowMaintenanceURL, testconstants.EnhancedSetupFlowMaintenanceURL),
	}
	common := []string{
...
func TestUpdateModel(t *testing.T) {
	...
	fields := []string{
		...
		fmt.Sprintf("--%s=%v", cli.FlagIcdUserActiveModeTriggerInstruction, testconstants.IcdUserActiveModeTriggerInstruction) + "-updated",
		...
		fmt.Sprintf("--%s=%v", cli.FlagEnhancedSetupFlowMaintenanceURL, testconstants.EnhancedSetupFlowMaintenanceURL+"/updated"),
