...
type MsgCreateModel struct {
	...
	SchemaVersion                              uint32 `protobuf:"varint,18,opt,name=schemaVersion,proto3" json:"schemaVersion,omitempty"`
}
...
type MsgUpdateModel struct {
	...
	SchemaVersion                              uint32 `protobuf:"varint,15,opt,name=schemaVersion,proto3" json:"schemaVersion,omitempty"`
}
...
var fileDescriptor_8898c625fa4755dc = []byte{
	...
	,
}
