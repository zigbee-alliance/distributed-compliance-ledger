...
func GetQueryCmd(queryRoute string, cdc *codec.Codec) *cobra.Command {
	// Group gov_old queries under a subcommand
...
proposal-id by running "%s query gov_old proposals".

Example:
$ %s query gov_old proposal 1
`,
...
Example:
$ %s query gov_old proposals --depositor cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ %s query gov_old proposals --voter cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ %s query gov_old proposals --status (DepositPeriod|VotingPeriod|Passed|Rejected)
`,
...
Example:
$ %s query gov_old vote 1 cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov_old deposit 1 cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.ClientName,
			),
		),
...
You can find the proposal-id by running "%s query gov_old proposals".

Example:
$ %s query gov_old deposits 1
`,
				version.ClientName, version.ClientName,
			),
		),
...
the proposal-id by running "%s query gov_old proposals".

Example:
$ %s query gov_old tally 1
`,
				version.ClientName, version.ClientName,
			),
		),
...
Example:
$ %s query gov_old param voting
$ %s query gov_old param tallying
$ %s query gov_old param deposit
`,
				version.ClientName, version.ClientName, version.ClientName,
			),
		),
