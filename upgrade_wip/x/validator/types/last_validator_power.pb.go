...
func (m *LastValidatorPower) GetConsensusAddress() string {
	if m != nil {
...
var fileDescriptor_830cb29c5288b722 = []byte{
	...
	0x45, 0x7a, 0x70, 0x13, 0x94, 0xc2, 0xb8, 0x84, 0x7c, 0x12, 0x8b, 0x4b, 0xc2, 0x60, 0x02, 0x01,
	0x20, 0x13, 0x85, 0xb4, 0xb8, 0x04, 0x92, 0xf3, 0xf3, 0x8a, 0x53, 0xf3, 0x8a, 0x4b, 0x8b, 0x1d,
	0x53, 0x52, 0x8a, 0x52, 0x8b, 0x8b, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x30, 0xc4, 0x85,
	0x44, 0xb8, 0x58, 0xc1, 0xce, 0x90, 0x60, 0x52, 0x60, 0xd4, 0x60, 0x0d, 0x82, 0x70, 0x9c, 0x52,
	...
	0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x1f, 0xe2, 0x64, 0x5d, 0x98, 0x9b, 0xf5, 0x91, 0xdc, 0xac,
	0x8b, 0x70, 0xb4, 0x2e, 0xc4, 0xd5, 0xfa, 0x15, 0xfa, 0x88, 0x80, 0x28, 0xa9, 0x2c, 0x48, 0x2d,
	0x4e, 0x62, 0x03, 0x7b, 0xdd, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xd9, 0x1f, 0x21, 0xcf, 0x22,
	0x01, 0x00, 0x00,
}
...
func (m *LastValidatorPower) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ConsensusAddress) > 0 {
		...
		i = encodeVarintLastValidatorPower(dAtA, i, uint64(len(m.ConsensusAddress)))
		i--
		dAtA[i] = 0xa
	}
