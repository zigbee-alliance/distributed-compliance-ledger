...
--description="CHIP Discoball" --sku=A1234GH --software-version="10123" --software-version-string="1.0b123"  --hardware-version="5123" \
--hardware-version-string="5.1.23"  --cd-version-number="32" \
--from=cool-vendor
