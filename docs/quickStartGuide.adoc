...
Flags:
  ...
  -h, --help                    help for dcld
      --home string             directory for config and data (default "~/.dcl")
  -o, --output string           Output format (text|json) (default "text")
      --trace                   print out full stack trace on errors

Use "dcld [command] --help" for more information about a command.
----
...
# dcld connects to a single node. Set following property to ensure every reply from node is
